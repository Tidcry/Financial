...
<head>
  ...
  <script type="text/javascript">
    ...
    //   Console:sfa;
    //   var type = $("#type").val();
    //   var price = $("#passWord").val();
    //   var date = $("#passWord").val();
    //   var remarks = $("#passWord").val();
    //
    //   $.ajax({
    //     url:"/Financial/PayInfoServlet",
    //     type:"post",
    //     data:{
    //       type:type,
    //       price:price,
    ...
    //       // window.location.href='/Financial/index.jsp';
    //     }
    //   });
    //
    // }
          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="addIncome.jsp">新增支出账单</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 账单管理 - 新增支出账单 </span>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
<!--                提交信息到后台-->
                <form action="/Financial/PayInfoServlet?method=add" method="post" class="row">
                  <div class="form-group col-md-12">
                    <label for="type">支出事由</label>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="title" name="price" value="" autocomplete="off" placeholder="请输入金额" />
                  </div>
                  <div class="form-group col-md-12">
                    <label for="seo_keywords">日期</label>
                    <input type="text" class="form-control js-datepicker" id="seo_keywords" name="date" value="" autocomplete="off" placeholder="请选择日期" data-date-format="yyyy-mm-dd"/>
                  </div>
                  <div class="form-group col-md-12">
