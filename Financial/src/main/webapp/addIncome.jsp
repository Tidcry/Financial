...
<head>
  ...
  <script type="text/javascript">
    ...
    //
    //   $.ajax({
    //     url:"/Financial/IncomeInfoServlet",
    //     type:"post",
    //     data:{
    //       type:type,
    //       price:price,
          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="addIncome.jsp">新增收入账单</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 账单管理 - 新增收入账单 </span>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
<!--                提交信息到后台-->
                <form action="/Financial/IncomeInfoServlet?method=add" method="post" class="row">
