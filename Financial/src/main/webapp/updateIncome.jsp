...
<head>
  ...
  <%
    ...
    Income income=incomeDao.getIncomeByIncomeId(Integer.parseInt(incomeId));
    System.out.println("------------"+income.getType());
  %>
          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"><a href="updateIncome.jsp">编辑收入账单</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 账单管理 - 修改收入账单 </span>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
<!--                提交信息到后台-->
                <form action="/Financial/IncomeInfoServlet?method=update&incomeId=<%=income.getIncomeId()%>" method="post" class="row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="title" name="price" value="<%=income.getPrice()%>" autocomplete="off" placeholder="请输入金额" />
                  </div>
                  <div class="form-group col-md-12">
                    <label for="seo_keywords">日期</label>
                    <input type="text" class="form-control js-datepicker" id="seo_keywords" name="date" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(income.getDate())%>" autocomplete="off" placeholder="请选择日期" data-date-format="yyyy-mm-dd"/>
                  </div>
                  <div class="form-group col-md-12">
                    <label for="seo_description">备注</label>
                    <textarea class="form-control" id="seo_description" name="remarks" rows="5" value="" autocomplete="off" placeholder="描述"><%=income.getRemarks()%></textarea>
                  </div>
                  <div class="form-group col-md-12">
...
<script type="text/javascript">
  $("#type").val("<%=income.getType()%>"); // 设置Select的Value值为?的项选中
</script>
</body>
</html>